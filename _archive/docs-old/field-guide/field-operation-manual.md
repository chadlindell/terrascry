...
### 4.1 Pre-Measurement Setup (Web UI)



**Using the HIRT Field Controller:**



1.  **Connect to Controller:**

    -   Power on the Base Hub.

    -   On your tablet/phone, connect to WiFi Network: **`HIRT-Field-Net`**

    -   Password: **`hirt-survey-2026`**



2.  **Access Dashboard:**

    -   Open Chrome/Safari and navigate to: **`http://192.168.4.1`**

    -   Verify the dashboard shows **"System Status: IDLE"**.



3.  **Configure Scan:**

    -   **Survey Name:** Enter unique name (e.g., `Site_Bravo_Grid_1`).

    -   **Operator:** Enter your initials.

    -   **Site ID:** Enter the grid reference.
...
4.  **Verify Start:**
    ...
    -   "Samples Collected" counter should start incrementing.

    -   **Note:** Do not close the browser tab while scanning.



5.  **Background Measurement** (Optional):

    -   Perform a short "Test Scan" (1 min) outside the target area first to verify noise levels.
