...
| W1 | Magnet Wire | 34-38 AWG, 50m | 1 | $3-5 | High turn count |
...
## Zone Wiring BOM (6 Zones)

### Zone Hubs (Passive Breakouts)

| Ref | Component | Description | Qty | Unit Cost |
|-----|-----------|-------------|-----|-----------|
| BOX1 | Enclosure | IP65 100x100mm | 6 | $5-8 |
| CON1 | DB25 Connector | Panel mount female | 6 | $2-3 |
| TB1 | Terminal Blocks | 4-position screw | 24 | $1 |
| GL1 | Cable Glands | PG7 for probes | 24 | $0.50 |

### Trunk Cables

| Ref | Component | Description | Qty | Unit Cost |
|-----|-----------|-------------|-----|-----------|
| TRK1 | DB25 Cable | Shielded M-M, 10-15m | 6 | $15-25 |
| ADP1 | Gender Changer | If needed | - | - |

### Probe-to-Zone Cables

| Ref | Component | Description | Qty | Unit Cost |
|-----|-----------|-------------|-----|-----------|
| CBL1 | Shielded Cable | 6-conductor, 1-2m | 24 | $5-8 |
| CON2 | Ferrules | Wire termination | 200 | $5 |
