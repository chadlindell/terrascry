...
Scientific data reporting requires characterizing not just the value, but the uncertainty of that value.

### 1. Error Classification

*   **Systematic Error (Bias):** Consistent offsets caused by component tolerance (e.g., a 1% resistor being 1.01k). **Action:** Removed via Calibration.
*   **Random Error (Noise):** Unpredictable fluctuations (Thermal noise, ADC jitter). **Action:** Reduced via Averaging/Integration.

### 2. Uncertainty Budget (Typical)

| Source | Type | Magnitude | Distribution |
|--------|------|-----------|--------------|
| Reference Resistor (R_sense) | Systematic | 0.1% | Rectangular |
| ADC Quantization | Random | < 1 uV | Uniform |
| Thermal Drift (Tempco) | Systematic | 50 ppm/C | Linear |
| Probe Geometry (Placement) | Random | +/- 1 cm | Normal |
| **Total Combined Uncertainty** | **Mixed** | **~1-2%** | **(k=2)** |

### 3. Reporting Standards

All final data products must be reported with 95% confidence intervals (k=2):
$$ Measurement = X \pm 2\sigma $$
