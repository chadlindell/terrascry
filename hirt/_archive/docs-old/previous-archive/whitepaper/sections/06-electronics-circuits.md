...
- Power only needed for signal generation at the Hub.
- Much lower system complexity per probe.
...
**Primary:** WiFi (ESP32) to Tablet/Laptop
**Backup:** USB-Serial to Tablet/Laptop

### Data Rate Requirements

- **MIT:** Moderate (sweep takes seconds per frequency)
- **ERT:** Low (voltage readings every 1-2 seconds)
- **Total:** <100 kbps sufficient
