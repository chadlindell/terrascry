...
4. **MIT Baseline:** Verify TX->RX coupling on two probes in air before insertion.

### Quick Reference Table

| Symptom | Likely Cause | Fix |
|---------|--------------|-----|
| **RX saturation on nearby probes** | TX too strong | Lower TX level; rotate coils to orthogonal position |
| **Noisy MIT data** | Trunk shielding issue | Check trunk cable ground; verify single-point star ground at Hub |
...
| **Inconsistent repeats** | Thermal drift | Allow 15 min Hub warmup; check if Hub fans are active |
