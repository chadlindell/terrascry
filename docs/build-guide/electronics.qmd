...
#| fig-cap: "AD7124-8 ADC interface showing differential analog inputs for MIT and ERT signals, SPI connection to MCU, and integrated reference. The integrated AFE, 24-bit resolution, and three power modes provide excellent dynamic range with minimal external components."
#| fig-width: 9
#| fig-height: 5
#| code-fold: true
...
| Power Modes | Full (970 µA), Mid (660 µA), **Low (255 µA)** |
