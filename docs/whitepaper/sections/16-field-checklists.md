...
- [ ] Check probe orientation (if applicable)
- [ ] Verify all probes have power
- [ ] Test communications with all probes
...
- Team: ___________
- Weather: ___________
- Soil conditions: ___________

### Measurements
- Probes deployed: ___________
- MIT frequencies: ___________
- ERT baselines: ___________
