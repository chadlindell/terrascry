...
- Cable connects:
  - TX coil to central TX driver
  - RX coil to central RX amplifier
  - ERT rings to central ERT system
...
**12-pin Phoenix Contact (1757248):**
...
+-----------------------------+
|  Front panel (glands, UI)   |  Probe harness bulkhead
+-----------------------------+
|  Backplane PCB (160x120mm)  |  DDS, TX/RX, ERT, MCU
+-----------------------------+
|  Harness strain relief bar  |  Shielded cables + labels
+-----------------------------+
...
| Control/Sync | Scheduling, logging | ESP32, RS-485 |
| Power | Regulation | DC-DC, LDO |

### Front Panel Layout

1. **Left column:** M20 glands for probe bundles
2. **Center column:** RJ45, USB-C, SMA (GPS)
3. **Right column:** DC jack, Anderson connector, LEDs, reset
