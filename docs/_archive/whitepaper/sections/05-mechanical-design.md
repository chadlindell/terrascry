...
3. **Rod diameter standard: 16 mm OD**
   - 16 mm = Robust hiking pole standard
   - Hole size: 18-20 mm (much less destructive than 50 mm)
   - Allows for strong M12 threads
...
1. Use **3D-printed insulating collars** (5 mm wide x 16 mm ID)
...
|-----------|-------|
| Total Length | 25 mm |
| Base Diameter | 16 mm (Flush with rod) |
| Point Diameter | 4 mm |
| Thread | Internal M12x1.75 |
...
|-----------|-------|
| Total Length | 45 mm |
| Outer Diameter | 16 mm (Flush fit) |
| Thread | Internal M12x1.75 both ends |
