...
- Located exclusively in the **Central Hub**; manages signal generation, multiplexing, and data acquisition.
...
**Zone Hub**
- A local, passive breakout box that aggregates 4 probes into a single high-density trunk cable.

**Trunk Cable**
- A high-density shielded multi-core cable (e.g., DB25) that carries analog signals from a Zone Hub to the Central Hub.
